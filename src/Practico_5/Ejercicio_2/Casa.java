...
public class Casa {
    private ArrayList<String> nombreCasa; //griffyndor - slytherin
    ...
    public Casa(int cantMaximaAlumnoAdmitido) {
        this.cantMaximaAlumnoAdmitido = cantMaximaAlumnoAdmitido;
        this.cantAlumno = 0;
        this.nombreCasa = new ArrayList<>();
    ...
    public ArrayList<String> getCasa(){
